...
public class Bank {
    ...
    public double getCombined(double checking, double savings){
        return Calculator.add(checking, savings);
    }

    // checking deposit
    public void checkingDeposit(double amount){
        checking = Calculator.add(checking, amount);
    }

    //savings deposit
    public void savingsDeposit(double amount){
        savings = Calculator.add(savings, amount);
    }

    // checking withdraw
    public void checkingWithdraw(double amount){
        checking = Calculator.sub(checking, amount);
    }

    // savings withdraw
    public void savingsWithdraw(double amount){
        savings = Calculator.sub(savings, amount);
    }
